...
A geo-direction is a kind of direction. Front is a geo-direction. Back is a geo-direction. Left is a geo direction. Right is a geo-direction. 	
Geo-moving is an action applying to one visible thing. Understand "geo-move [noun]" as geo-moving.
Check geo-moving:
	if the noun is not a geo-direction:
		say "You can only geo-move in a geo-direction." instead.
Carry out geo-moving:
	execute JavaScript command "isovist.step('player', [noun])";
	if the JavaScript command returned true:
		update the isovist;
		say "You take a step to the [noun].";
		try looking;
	else:
		say "You can't move [noun].".
Geo-turning is an action applying to one visible thing. Understand "geo-turn [noun]" as geo-turning.
Check geo-turning:
	if the noun is not a geo-direction:
		say "You can only geo-turn in a geo-direction." instead.
Carry out geo-turning:
	execute JavaScript command "isovist.turn('player', [noun])";
	if the JavaScript command returned true:
		update the isovist;
		say "You turn to the [noun].";
		try looking;
	else:
		say "You can't turn [noun].".
